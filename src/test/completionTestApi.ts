...
class SyncContentProvider implements completion.ICompletionContentProvider {
...
export function completionByOffset(filePath: string, offset: number): string {
    var completionProvider: CompletionProvider = new CompletionProvider(new SyncContentProvider());
